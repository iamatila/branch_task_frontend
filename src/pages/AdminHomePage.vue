<template>
  <q-page class="q-pa-md">
    ...
    <div class="q-pt-md">
      ...
      <div class="row q-pt-sm">
        <div class="col-12 col-md-6 q-pl-md">
          <q-input readonly hint="Admin Type" class="" outlined :label="data.admintype" />
        </div>
        <div class="col-12 col-md-6 q-pl-md">
          <q-input readonly hint="Admin ID" class="" outlined :label="data.adminid" />
        </div>
      </div>
      <div class="row q-pt-sm">
        <div class="col-12 col-md-6 q-pl-md">
...
var adminid = useStore.getAdminId

const name = 'AdminHomePage'
