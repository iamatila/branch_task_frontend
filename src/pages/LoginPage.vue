            ...
            <div class="userLogin">
                <q-card class="my-card text-white" style="max-width: 400px">
                    ...
                    <div class="q-pa-md">
                        ...
                        <q-separator />
                        <div class="text-black q-pa-sm q-ma-md text-center">
                            Are you an Admin?
                            <router-link class="text-primary" to="/admin-login" style="text-decoration: none">
                            Admin Login
                            </router-link>
        ...
        <div class="column full-height">
          ...
          <div class="col-10 ">
            <div class="adminLogin">
              <q-card class="my-card text-white" style="max-width: 400px">
                <q-card-section>
                  <div class="text-h4 text-weight-bold q-pa-md text-primary">Admin Login</div>
                  <div class="text-6 q-pl-md q-pr-md q-pt-sm q-pb-sm text-primary">
                    Welcome, let’s access
                    your accounts shall we?
                  </div>
                ...
                <q-card-section>
                  <div class="q-pa-md">
                    <q-form @submit="onAdminSubmit" @reset="onAdminReset" class="">
                      ...
                      <div class="q-pt-md">
                        <q-btn :loading="adminloadingLogin" class="full-width" label="Submit" type="submit" color="primary" />
                      </div>
                    </q-form>
                    <div class="text-black q-pa-sm text-center">
                        Don't have an account yet?
                        <router-link class="text-primary" to="/admin-signup" style="text-decoration: none">
                        Sign up
                        </router-link>
