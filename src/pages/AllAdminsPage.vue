<template>
  <q-page class="q-pa-md">
    <div class="text-black text-h4">All Admin Users</div>
      <q-separator />
    <div class="q-gutter-y-md q-pt-md" full-width>
      <div class="q-pa-md row items-start q-gutter-md">
        <q-card class="my-card" v-for="(admin, index) in data" :key="index">
          ...
          <q-btn flat @click="viewMore(admin)">See Details...</q-btn>
        </q-card-actions>
        </q-card>
